<header id="header" class="full-header">
    ...
    <div id="header-wrap">
        ...
        <div class="container clearfix">
            ...
            ============================================= -->
            <div id="logo">
                <a href="index.html" class="standard-logo" data-dark-logo="{{ asset('theme/images/logo-dark.png') }}"><img src="{{ asset('theme/images/logo.png') }}" alt="Logo"></a>
                <a href="index.html" class="retina-logo" data-dark-logo="{{ asset('theme/images/logo-dark@2x.png') }}"><img src="{{ asset('theme/images/logo@2x.png') }}" alt="Logo"></a>
            </div><!-- #logo end -->
