...
@section('head')
@parent
    <script src="{{ asset('assets/admin/theme/vendors/custom/datatables/datatables.bundle.js') }}"></script>
    <link rel="stylesheet" href="{{ asset('assets/admin/theme/vendors/custom/datatables/datatables.bundle.css') }}">
@endsection
