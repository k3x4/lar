...
<?php echo Form::model($feature, ['method' => 'PATCH','route' => ['admin.features.update', $feature->id]]); ?>
    ...
    <div class="col-lg-8">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Edit Feature <strong><?php echo e($feature->title); ?></strong></h3>
            </div>
