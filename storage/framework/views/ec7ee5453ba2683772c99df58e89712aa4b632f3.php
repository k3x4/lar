...
<div class="row">
    <div class="col-lg-12 margin-bottom">
        <div class="pull-right">
            <a class="btn btn-primary" href="<?php echo e(route('admin.fieldgroups.index')); ?>"> Back</a>
        </div>
    </div>
</div>
...
<?php echo Form::model($fieldGroup, ['method' => 'PATCH', 'route' => ['admin.fieldgroups.update', $fieldGroup->id]]); ?>
    ...
    <div class="col-lg-8">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Edit Field Group <strong><?php echo e($fieldGroup->title); ?></strong></h3>
            </div>
            <div class="box-body">
