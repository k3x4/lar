...
<div class="row">
    <div class="col-lg-12 margin-bottom">
        <div class="pull-right">
            <?php if (\Entrust::can('fieldgroup-create')) : ?>
            <a class="btn btn-success" href="<?php echo e(route('admin.fieldgroups.create')); ?>"> New Field Group</a>
    ...
    <div class="col-lg-12">
        <div class="box">
            ...
            <div class="box-body">
                ...
                <?php if (\Entrust::can('fieldgroup-delete')) : ?>
                    <?php echo Form::open(['method' => 'DELETE', 'route' => ['admin.fieldgroups.destroy'], 'class' => 'deleteForm']); ?>
